...
<html>
	...
	<body>
		...
		<div class="content">			
			<h2>Sms Raporları</h2>
			<br>
			<h4>Atılan Sms Sayısı:
				<?php 
					$count=0;
					$sayc=$connection->query("SELECT * FROM ".$_SESSION['name']."Rapor where tur='sms'"); 
			...
			<section>
					...
					<table id="raportablo">
						<thead>
							<tr>
								...
								<th><div style="width:290px;">Sms İçeriği</div></th>
				...
				<div class="tbl-content">
					<table id="raportablo" border="1">
						<?php            
							$sorgu = $connection->query("select * from ".$_SESSION['name']."Rapor where tur='sms'");
